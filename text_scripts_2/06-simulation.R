...
#' 
#' * The kind asks, "Great work, what do you want from me as a reward? You name it, I will make your wish come true."
...
#' ## Exercises 
#' 
#' Complete these exercises using the `Unit_6_ex.Rmd` file.
#' 
