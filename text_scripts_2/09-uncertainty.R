...
#' 
#' That is almost a *22 hour* delay -- better get a sleeping bag!
#' 
#' ## Percentiles 
#' 
...
#' 
#' Note that this simulation will take awhile (> 20 minutes). Grab a coffee!
#' 
...
#' ## Exercises 
#' 
#' Complete these exercises using the `Unit_9_ex.Rmd` file.
#' 
