...
#' 
## ----dpi=80, echo=FALSE, fig.align="center", warning = FALSE----
swapped <- corr_tibble |>
  filter(dataset == 'linear') |>
...
#' 
## ----dpi=80, fig.align="center", eval = FALSE, message = FALSE----
## ggplot(my_penguins,
...
#' 
#' When `species` is *excluded* from the model, we find a negative estimate for the slope. When `species` is included, as in the one-factor model, the sign of the slope is flipped. This effect is known as __Simpson's paradox__.
#' 
...
#' 
#' We can accomplish the work with `tidymodels` using the function `predict`. Note that this function receives a dataset in the form of a data frame or tibble, and returns the prediction(s) as a tibble.  
#' 
## -----------------------------------------------------------
...
#' 
## ----eval = FALSE, fig.height=6, fig.width=4----------------
## #melt your data
