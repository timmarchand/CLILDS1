...
knitr::include_graphics(here('images','vector_diagram1.png'))
```
...
```{r, echo=FALSE, fig.align="center", out.width='60%', fig.asp=1/2}
knitr::include_graphics(here('images','vector_diagram2.png'))
```
...
```{r, echo=FALSE, fig.align="center", out.width='60%', fig.asp=1/2}
knitr::include_graphics(here('images','vector_diagram3.png'))
```
...
knitr::include_graphics(here('images','list_visual.png'))
```
